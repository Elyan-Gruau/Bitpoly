...
public class Plateau {
	...
	public Plateau() {
		...
		plateau.add(new Case("IMPOT revenu",60,LotType.IMPOT_REV));               //4 IMPOT REVENU -1000
		plateau.add(new Case("Gare Monparnasse",0,LotType.GARE));                 //5 G. Monparnasse
		plateau.add(new Case("Rue du Quc",100,LotType.LAND,GRP.C));                    //6 R.
		plateau.add(new Case("Chance",0,LotType.GARE));                           //7 Chance
		plateau.add(new Case("Rue Tapmensinq",100,LotType.LAND,GRP.C));                    //8 R.
		plateau.add(new Case("Av. Roco",150,LotType.LAND,GRP.C));                    //9 R.
		
		plateau.add(new Case("Prison",0,LotType.PRISON));                              //10 PRISON (VISITE)
		plateau.add(new Case("Rue des Potiers",520,LotType.LAND,GRP.E));                     //11 lot
		...
		plateau.add(new Case("Bv. Ricard",130,LotType.LAND,GRP.B));                   //16 lot
		...
		plateau.add(new Case("P. St. Valériane",1256,LotType.LAND,GRP.S));                  //28 l1
